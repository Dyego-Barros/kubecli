...
def build_parser() -> argparse.ArgumentParser:
    ...
    mcp.add_argument("mcp_action", nargs="?", choices=("list", "test", "call", "ask"), default="list")
    mcp.add_argument("server", nargs="?", help="Nome do servidor MCP para call.")
    mcp.add_argument("tool", nargs="?", help="Nome exato da tool para call.")
    mcp.add_argument("--arguments", default="{}", help="Argumentos JSON da tool.")
